...
module Warden
  class Repl
      ...
      begin
        ...
        when :command_help
          ...
          if type == :stream || type == :run
            ...
            obj = handle_run_command(obj) if type == :run
          ...
          command_info[:result] = describe_response(serialized)
        end
      rescue => e
    ...
    # TODO(kowshik): Implement this.
    def handle_run_command(obj) do
        spawn_command = convert_to_spawn_command(obj, :spawn)
