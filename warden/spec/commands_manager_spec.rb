  ...
  describe "#new" do
    it "should raise an error when a non-string object is passed" do
      expect {
        ...
        msg = "Expected argument to be of type: #{String}"
        msg << ", but received: #{Object}."
...
describe Warden::CommandsManager do
    ...
    context "reject invalid protocol objects" do
      it "should raise an error when non-protocol buffer object is passed" do
        expect {
          ...
          msg << " #{Warden::Protocol::BaseMessage}, but received: #{Object}."
          error.message.should == msg
        }
      end
  ...
  describe "#convert_to_spawn_command" do
    it "should raise an error when run command is not passed as parameter" do
      expect {
        @subject.convert_to_spawn_command("test")
      }.to raise_error { |error|
        error.should be_an_instance_of ArgumentError
        msg = "Expected protocol buffer object to be of type:"
  ...
  describe "#generate_stream_command" do
    it "should raise an error when spawn command is not passed as parameter" do
      expect {
        @subject.generate_stream_command("test", nil)
      }.to raise_error { |error|
        error.should be_an_instance_of ArgumentError
        msg = "Expected protocol buffer object to be of type:"
    ...
    it "should raise an error when spawn response is not passed as parameter" do
      expect {
        @subject.generate_stream_command(Warden::Protocol::SpawnRequest.new,
                                         "test")
      }.to raise_error { |error|
        error.should be_an_instance_of ArgumentError
        msg = "Expected protocol buffer object to be of type:"
