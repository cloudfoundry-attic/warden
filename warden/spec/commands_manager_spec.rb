...
test_klass_map = {
  ...
  6 => BadEnumTest,
  7 => WrongTypeTest,
  8 => SimpleFieldsHelpTest,
  9 => NestedFieldsHelpTest
}

desc_map = {}
test_klass_map.each_pair do |k, type|
  desc_map[type.type_underscored] = type.description
end
  ...
  describe "#deserialize" do
    ...
    context "generate help" do
      ...
      it "should generate help for a command with simple field(s)" do
        ...
        help.should == {
          :simple_fields_help_test => {
            ...
            :required => {
              :req_field => "--req_field <req_field> (string)",
              :req_bool_field => "--req_bool_field",
            },
            :optional => {
              :opt_field => "[--opt_field] <opt_field> (string)",
            },
            :repeated => {
              :rep_field => "--rep_field[index] <rep_field> (uint32)",
            }
          }
        }
      end
      ...
      it "should generate descriptions for all commands" do
        @subject.command_descriptions.should == desc_map
      end
      ...
      it "should cache the generated descriptions of commands" do
        ...
        hash_1.should == desc_map
        hash_2.should == desc_map
